            ...
            <div className='w-full flex flex-row justify-start items-center gap-2'>
                <div className="collapse ">
                    ...
                    <div className="collapse-content flex flex-col gap-2 py-0">
                        ...
                        <Link to={'/banners'} className={`w-full flex flex-row justify-start items-center gap-2 cursor-pointer hover:bg-[#f6f6f6] py-2 px-1 ${selectedItem.banners === true ? "border-l-4  border-indigo-500" : ""}`} onClick={() => sidebarClick("banners")}>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-bookmarks" viewBox="0 0 16 16">
                                    <path d="M2 4a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v11.5a.5.5 0 0 1-.777.416L7 13.101l-4.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v10.566l3.723-2.482a.5.5 0 0 1 .554 0L11 14.566V4a1 1 0 0 0-1-1z" />
                                    <path d="M4.268 1H12a1 1 0 0 1 1 1v11.768l.223.148A.5.5 0 0 0 14 13.5V2a2 2 0 0 0-2-2H6a2 2 0 0 0-1.732 1" />
